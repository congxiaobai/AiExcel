...
export default () => {
    ...
    return <Tabs aria-label="Options" isVertical={true} className="p-2">
        <Tab key="selection" title="操作选择区数据" className="flex-1 ">
            ...
            />
                <Button color="success" >执行</Button>
            </div>
        </Tab>
        <Tab key="current" title="操作当前页" className="flex-1">
            <div className="flex gap-2 items-end">  <Textarea
                label="输入指令"
                value={promotText}
                className="w-1/2"
        ...
        <Tab key="pages" title="操作多页数据" className="flex-1">
